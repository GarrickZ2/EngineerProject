...
public class Recipient {
    ...
    public Recipient(String recipientsName){
    ...
    public static void main(String[] args) throws Exception{
        Recipient recipient = new Recipient("20200429221734");
        System.out.println(recipient.getNoodle());
        System.out.println(recipient.getNoodlePrice());
        System.out.println(recipient.getNoodleTotalPrice());
        System.out.println(recipient.getNori());
        System.out.println(recipient.getEgg());
        System.out.println(recipient.getShoot());
        System.out.println(recipient.getChashu());
    }
}
