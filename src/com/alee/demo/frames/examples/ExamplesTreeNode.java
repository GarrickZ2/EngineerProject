        ...
        TextBridge<TreeNodeParameters<ExamplesTreeNode, JTree>>
{
     ...
     * Make sure to call this only if type of the node is {@link ExamplesTreeNodeType#group}.
     *
    ...
    /**
     * Returns example.
     * Make sure to call this only if type of the node is {@link ExamplesTreeNodeType#example}.
     *
     * @return example
     */
