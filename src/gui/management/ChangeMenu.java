...
public class ChangeMenu extends JPanel {
    ...
    public JSpinner getNoodlePrice() {
        return noodlePrice;
    }

    public void setNoodlePrice(JSpinner noodlePrice) {
        this.noodlePrice = noodlePrice;
    }

    public JSpinner getNoriPrice() {
        return noriPrice;
    }

    public void setNoriPrice(JSpinner noriPrice) {
        this.noriPrice = noriPrice;
    }

    public JSpinner getEggPrice() {
        return eggPrice;
    }

    public void setEggPrice(JSpinner eggPrice) {
        this.eggPrice = eggPrice;
    }

    public JSpinner getShootPrice() {
        return shootPrice;
    }

    public void setShootPrice(JSpinner shootPrice) {
        this.shootPrice = shootPrice;
    }

    public JSpinner getChashuPrice() {
        return chashuPrice;
    }

    public void setChashuPrice(JSpinner chashuPrice) {
        this.chashuPrice = chashuPrice;
    }

    public JToggleButton getNoriAvailable() {
        return noriAvailable;
    }

    public void setNoriAvailable(JToggleButton noriAvailable) {
        this.noriAvailable = noriAvailable;
    }

    public JToggleButton getEggAvailable() {
        return eggAvailable;
    }

    public void setEggAvailable(JToggleButton eggAvailable) {
        this.eggAvailable = eggAvailable;
    }

    public JToggleButton getShootAvailable() {
        return shootAvailable;
    }

    public void setShootAvailable(JToggleButton shootAvailable) {
        this.shootAvailable = shootAvailable;
    }

    public JToggleButton getChashuAvailable() {
        return chashuAvailable;
    }

    public void setChashuAvailable(JToggleButton chashuAvailable) {
